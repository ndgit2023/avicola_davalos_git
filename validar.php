<?php
session_start(); // abre  la secion 
require_once("conexion.php");// llama  ala coexion .php

//$db->debug=true;  // se hacen visibles las lineas , es util para saber donde me estoy equivocando
...
echo"<html> 
       ...
       <body>
         <div class='banner'>SISTEMA AVICOLA</div>";

if ((isset($_POST["accion"])) and ($_POST["accion"]=="Ingresar")){ //isst es para ver si hay ono un valor , post es el que recibe el dato
    $nick = $_POST["nick"];
    ...
    $sql1 = $db->Prepare("SELECT clave
                          ...
                          AND estado <> 'X'   
                        ");
    $rs1 = $db->GetAll($sql1, array($nick)); // ejecutamos la consulta
...
echo"<div class='mensaje'>";
    ...
    echo"<h1>".$mensage1."</h1>";
    $nom_completo = '';
    session_destroy(); // cierra la cesion
    echo"<a href='index.php'>
                  <input type='button' value='Volver>>>'></input>
             </a>     
            ";
